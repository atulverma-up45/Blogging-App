...
export const fetchComments = async ({
  ...
  try {
    ...
    setParentCommentCountFun((preVal) => preVal + data?.comments?.length);
  ...
  return (
    <div
      className={
        ...
        " duration-700 max-sm:right-0 sm:top-0 w-[30%] min-w-[350px] h-full bg-white shadow-2xl p-8 px-16 overflow-y-auto overflow-x-hidden z-50"
      }
    >
