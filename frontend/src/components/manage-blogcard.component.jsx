...
const BlogStats = ({ stats }) => {
  return (
    <div className="flex gap-2 max-lg:mb-6 max-lg:pb-6 border-grey border-e-black">
        ...
        return !key.includes("parent") ? (
          <div
            ...
            className={
              ...
              (i != 0 ? " border-grey border-l border-2" : " ")
            }
          >
      ...
      <div className="flex gap-10 border-b mb-6 max-md:px-4 border-grey pb-6 items-center">
        ...
        <div className="flex flex-col justify-between py-2 w-full min-w-[300px]">
          ...
          <div className="flex gap-6 mt-3">
            ...
            <button
              onClick={(e) => {
                deleteBlog(blog, accessToken, e.target);
              }}
...
export const ManageDraftBlogPost = ({ blog }) => {
  ...
  return (
    <div className="flex gap-5 lg:gap-10 pb-6 border-b mb-6 border-grey">
      <h1 className="blog-index text-center pl-4 md:pl-4 flex-none">
